    ...
    fetch(panchang_url, request_options).then(response => {
        ...
        .then(result => {
            ...
            if (flag == 1) {
                ...
                if (result[0] == "Scanty") {
                    document.getElementById("bg_gif").style.background = 'url(https://thumbs.gfycat.com/CreativeThoroughHarvestmouse-max-1mb.gif)';
                    document.getElementById("bg_gif").style.backgroundSize = 'cover';
        ...
        .then(result => {
            ...
            for (let i = 0; i < 7; i++) {
                ...
                if (predict == "clear sky") {
                    ...
                    image_name = "../static/images/03d@2x.png";
                }
